				...
				{cartItems.length < 1 && (
					<div className="flex-[2] flex flex-col items-center pb-12 md:-mt-14">
						...
						<span className="text-center mt-4">
							Looks like you have not addded anything to your cart.
							<br />
							Go ahead and explore top catqegories
						</span>
						<Link
							href="/"
